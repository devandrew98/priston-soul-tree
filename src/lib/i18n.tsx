...
const DICT: Record<string, Entry> = {
  ...
  'mk.admin.dl.hint': { pt: 'Gerencie o executável do Overlay Timer Boss (botão de download da Home). Envie um novo arquivo para atualizar — troca na hora, sem novo deploy.', en: 'Manage the Overlay Timer Boss installer (the Home download button). Upload a new file to update it instantly, no redeploy.' },
  'mk.admin.dl.current': { pt: 'Arquivo atual', en: 'Current file' },
  'mk.admin.dl.none': { pt: 'Nenhum arquivo enviado ainda (usando o arquivo padrão do site).', en: 'No file uploaded yet (using the built-in fallback).' },
  'mk.admin.dl.updated': { pt: 'atualizado em', en: 'updated' },
  'mk.admin.dl.testdl': { pt: 'Baixar (testar)', en: 'Download (test)' },
  'mk.admin.dl.replace': { pt: 'Enviar novo arquivo', en: 'Upload new file' },
  'mk.admin.dl.versionph': { pt: 'Versão (opcional, ex.: 1.2.0)', en: 'Version (optional, e.g. 1.2.0)' },
  'mk.admin.dl.send': { pt: 'Enviar e publicar', en: 'Upload & publish' },
  'mk.admin.dl.uploading': { pt: 'Enviando...', en: 'Uploading...' },
  'mk.admin.dl.wait': { pt: 'O arquivo é grande — pode levar alguns minutos. Não feche a página.', en: 'Large file — this can take a few minutes. Do not close the page.' },
  'mk.admin.dl.done': { pt: 'Arquivo atualizado! O botão da Home já aponta para o novo download.', en: 'File updated! The Home button now points to the new download.' },
  'mk.admin.dl.toobig': { pt: 'Arquivo grande demais para o Storage do seu plano Supabase (o gratuito capa em ~50 MB). Precisaremos hospedar em outro lugar (ex.: GitHub Releases).', en: 'File too large for your Supabase plan storage (free caps at ~50 MB). We\'ll need to host it elsewhere (e.g. GitHub Releases).' },
