...
const DICT: Record<string, Entry> = {
  ...
  'home.download.notes.title': { pt: 'Novidades desta versão', en: "What's new in this version" },
  ...
  'mk.admin.download': { pt: 'Download', en: 'Download' },
  'mk.admin.dl.hint': { pt: 'Gerencie o instalador do Overlay Timer Boss (botão de download da Home). O arquivo mora numa Release do GitHub (banda ilimitada, não consome a cota do Supabase) — aqui você só aponta o link.', en: 'Manage the Overlay Timer Boss installer (the Home download button). The file lives in a GitHub Release (unlimited bandwidth, doesn\'t touch your Supabase quota) — here you just point at the link.' },
  'mk.admin.dl.current': { pt: 'Arquivo atual', en: 'Current file' },
  'mk.admin.dl.none': { pt: 'Nenhum link configurado ainda — o botão de download não aparece na Home.', en: 'No link set yet — the Home download button stays hidden.' },
  'mk.admin.dl.updated': { pt: 'atualizado em', en: 'updated' },
  'mk.admin.dl.testdl': { pt: 'Baixar (testar)', en: 'Download (test)' },
  'mk.admin.dl.replace': { pt: 'Atualizar link de download', en: 'Update download link' },
  'mk.admin.dl.steps': { pt: 'No GitHub do projeto: Releases → Draft a new release → anexe o .exe → Publish. Depois copie o link do arquivo anexado e cole abaixo.', en: 'In the project\'s GitHub: Releases → Draft a new release → attach the .exe → Publish. Then copy the attached file\'s link and paste it below.' },
  'mk.admin.dl.urlph': { pt: 'Link do arquivo na Release (https://github.com/.../releases/download/...)', en: 'Release asset link (https://github.com/.../releases/download/...)' },
  'mk.admin.dl.filenameph': { pt: 'Nome do arquivo (opcional)', en: 'File name (optional)' },
  'mk.admin.dl.versionph': { pt: 'Versão (opcional, ex.: 1.2.0)', en: 'Version (optional, e.g. 1.2.0)' },
  'mk.admin.dl.sizeph': { pt: 'Tamanho em MB (opcional)', en: 'Size in MB (optional)' },
  'mk.admin.dl.notesph': { pt: 'Notas de atualização (opcional) — aparece ao lado do botão na Home', en: 'Update notes (optional) — shown next to the button on Home' },
  'mk.admin.dl.send': { pt: 'Salvar link', en: 'Save link' },
  'mk.admin.dl.done': { pt: 'Link atualizado! O botão da Home já aponta para o novo download.', en: 'Link updated! The Home button now points to the new download.' },
  'mk.admin.imgopt': { pt: 'Otimizar imagens', en: 'Optimize images' },
  'mk.admin.imgopt.hint': { pt: 'Fotos de anúncio, avatares e capas de streamer enviadas antes da compressão automática existir podem estar bem maiores do que precisam — isso consome a cota de banda (Cached Egress) do Supabase. Esta ferramenta baixa, recomprime (WebP) e sobrescreve cada imagem no lugar, sem mudar links nem apagar nada.', en: 'Listing photos, avatars and streamer covers uploaded before auto-compression existed can be far bigger than needed — that eats into your Supabase bandwidth (Cached Egress) quota. This tool downloads, recompresses (WebP) and overwrites each image in place, without changing any links or deleting anything.' },
  'mk.admin.imgopt.scan': { pt: 'Verificando imagens...', en: 'Scanning images...' },
  'mk.admin.imgopt.found': { pt: '{n} imagens encontradas · {size} no total', en: '{n} images found · {size} total' },
  'mk.admin.imgopt.start': { pt: '🗜️ Otimizar agora', en: '🗜️ Optimize now' },
  'mk.admin.imgopt.running': { pt: 'Otimizando {done}/{total}...', en: 'Optimizing {done}/{total}...' },
  'mk.admin.imgopt.done': { pt: 'Concluído! {before} → {after} ({pct}% menor)', en: 'Done! {before} → {after} ({pct}% smaller)' },
  'mk.admin.imgopt.errors': { pt: '{n} imagens falharam (veja o console)', en: '{n} images failed (see console)' },
  ...
  'mk.admin.mktoggle.title': { pt: 'Marketplace', en: 'Marketplace' },
  'mk.admin.mktoggle.hint': { pt: 'Desative temporariamente o Marketplace pro público, sem perder anúncios, categorias ou configurações — reative quando quiser.', en: 'Temporarily hide the Marketplace from the public without losing listings, categories or settings — turn it back on whenever.' },
  'mk.admin.mktoggle.status.on': { pt: 'Ativo — visível para todos', en: 'Active — visible to everyone' },
  'mk.admin.mktoggle.status.off': { pt: 'Desativado — só admins veem', en: 'Disabled — only admins can see it' },
  'mk.admin.mktoggle.on': { pt: 'Ativar Marketplace', en: 'Enable Marketplace' },
  'mk.admin.mktoggle.off': { pt: 'Desativar Marketplace', en: 'Disable Marketplace' },
  'mk.disabled.title': { pt: 'Marketplace temporariamente desativado', en: 'Marketplace temporarily unavailable' },
  'mk.disabled.body': { pt: 'Estamos com o Marketplace fora do ar por um tempo. Volte mais tarde!', en: "We've taken the Marketplace offline for a while. Please check back later!" },
  'mk.disabled.adminnote': { pt: 'O Marketplace está desativado para o público — só administradores veem esta tela. Reative em Admin → Notificação global.', en: 'The Marketplace is disabled for the public — only admins can see this. Re-enable it under Admin → Global notice.' },
  ...
  'st.totals.ptsnote': { pt: '16 pontos (níveis 1–80) + 1 por nível de fusão. Digite o seu nível de fusão e a árvore recalcula os pontos.', en: '16 points (levels 1–80) + 1 per fusion level. Enter your fusion level and the tree recalculates the points.' },
